...
Main.__name__ = true;
Main.main = function() {
	kha_System.start(new kha_SystemOptions("007 - Font & Text",Main.WIDTH,Main.HEIGHT,null,null),function(_) {
...
var Project = function() {
	this.font = kha_Assets.fonts.BirdsOfParadise;
};
...
Project.prototype = {
	...
	,render: function(framebuffer) {
		...
		g.set_fontSize(128);
		g.set_color(kha__$Color_Color_$Impl_$.fromBytes(123,234,12,255));
		g.drawString("This is a font test",100,100);
		g.end();
	}
	,__class__: Project
};
...
var kha__$Assets_FontList = function() {
	this.names = ["BirdsOfParadise","OpenSans","Signatra"];
	this.SignatraDescription = { name : "Signatra", files : ["Signatra.ttf"], type : "font"};
	this.SignatraName = "Signatra";
	this.Signatra = null;
	this.OpenSansDescription = { name : "OpenSans", files : ["OpenSans.ttf"], type : "font"};
	this.OpenSansName = "OpenSans";
	this.OpenSans = null;
	this.BirdsOfParadiseDescription = { name : "BirdsOfParadise", files : ["BirdsOfParadise.ttf"], type : "font"};
	this.BirdsOfParadiseName = "BirdsOfParadise";
	this.BirdsOfParadise = null;
};
...
kha__$Assets_FontList.prototype = {
	...
	,BirdsOfParadise: null
	,BirdsOfParadiseName: null
	,BirdsOfParadiseDescription: null
	,BirdsOfParadiseLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "BirdsOfParadiseLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadFont("BirdsOfParadise",function(font) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "BirdsOfParadiseLoad"});
	}
	,BirdsOfParadiseUnload: function() {
		this.BirdsOfParadise.unload();
		this.BirdsOfParadise = null;
	}
	,OpenSans: null
	,OpenSansName: null
	...
	,Signatra: null
	,SignatraName: null
	,SignatraDescription: null
	,SignatraLoad: function(done,failure) {
		var tmp;
		if(failure != null) {
			tmp = failure;
		} else {
			var f = haxe_Log.trace;
			var infos = { fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "SignatraLoad"};
			tmp = function(v) {
				f(v,infos);
			};
		}
		kha_Assets.loadFont("Signatra",function(font) {
			done();
		},tmp,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.FontList", methodName : "SignatraLoad"});
	}
	,SignatraUnload: function() {
		this.Signatra.unload();
		this.Signatra = null;
	}
	,names: null
...
kha_SystemImpl.loadFinished = function(defaultWidth,defaultHeight) {
	...
	try {
		...
		var e1 = (e instanceof js__$Boot_HaxeError) ? e.val : e;
		haxe_Log.trace("Could not initialize WebGL 2, falling back to WebGL.",{ fileName : "kha/SystemImpl.hx", lineNumber : 338, className : "kha.SystemImpl", methodName : "loadFinished"});
	}
	if(!kha_SystemImpl.gl2) {
		try {
			...
			haxe_Log.trace("Could not initialize WebGL, falling back to <canvas>.",{ fileName : "kha/SystemImpl.hx", lineNumber : 360, className : "kha.SystemImpl", methodName : "loadFinished"});
		}
	}
	...
	if(!kha_SystemImpl.soundEnabled) {
		...
		if(context != null) {
			context.resume().then(function(c) {
				...
				haxe_Log.trace(err,{ fileName : "kha/SystemImpl.hx", lineNumber : 600, className : "kha.SystemImpl", methodName : "unlockSound"});
			});
		}
	}
